describe('UserService', function () {
  ...
  it('should join the first name and last name of the user', function () {
    expect(UserService.createFullName({first_name: 'Frosty', last_name: 'Snowman'})).toEqual('Frosty Snowman');
  });
